...
/* main.posters.twig */
class __TwigTemplate_85bdb28240ff56997703051a6ad917bd318600ca9b0b96ed6fd6209e2316e226 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <form method=\"get\" action=\"\">
        ...
        // line 17
        echo twig_escape_filter($this->env, ($context["searchQuery"] ?? null), "html", null, true);
        echo "\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["color"]) {
            // line 22
            echo "                <option value=\"";
            echo twig_escape_filter($this->env, twig_lower_filter($this->env, twig_get_attribute($this->env, $this->source, $context["color"], "name", [], "any", false, false, false, 22)), "html", null, true);
            echo "\" ";
            if ((0 === twig_compare(($context["selectedColor"] ?? null), twig_get_attribute($this->env, $this->source, $context["color"], "id", [], "any", false, false, false, 22)))) {
                echo "selected";
            }
            echo ">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["color"], "name", [], "any", false, false, false, 22), "html", null, true);
            echo "</option>
            ";
        }
    ...
    <div class=\"poster-container\">
        ...
        if ((1 === twig_compare(twig_length_filter($this->env, ($context["posters"] ?? null)), 0))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["poster"]) {
                // line 38
                echo "                <a href=\"/";
                echo twig_escape_filter($this->env, twig_replace_filter(twig_get_attribute($this->env, $this->source, $context["poster"], "name", [], "any", false, false, false, 38), [" " => "-"]), "html", null, true);
                echo "-poster\">
                    <div class=\"poster-card\">
                        <img class=\"poster-image\" src=\"/assets/posters/";
                // line 40
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["poster"], "image", [], "any", false, false, false, 40), "html", null, true);
                echo "\" alt=\"";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["poster"], "image", [], "any", false, false, false, 40), "html", null, true);
                echo "\">
                        <ul class=\"poster-ul\">
                ...
                // line 43
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["poster"], "name", [], "any", false, false, false, 43), "html", null, true);
                echo "</p>
                ...
                // line 46
                echo "                                    ";
                $context["price"] = (($context["price"] ?? null) + twig_get_attribute($this->env, $this->source, $context["poster"], "extra_price", [], "any", false, false, false, 46));
                // line 47
                echo "                                    From ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["userLike"]) {
                    // line 53
                    echo "                                    ";
                    if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["userLike"], "product_id", [], "any", false, false, false, 53), twig_get_attribute($this->env, $this->source, $context["poster"], "id", [], "any", false, false, false, 53)))) {
                        // line 54
                        echo "                                        ";
                        $context["like"] = "-liked";
                        // line 55
                ...
                // line 59
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["poster"], "id", [], "any", false, false, false, 59), "html", null, true);
                echo "\">
                ...
                // line 64
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["poster"], "likes", [], "any", false, false, false, 64), "html", null, true);
                echo "</p>
                            </li>
                        </ul>
                    </div>
...
";
    ...
    {
        return array (  310 => 98,  297 => 87,  294 => 86,  290 => 85,  277 => 75,  275 => 74,  272 => 73,  268 => 71,  265 => 70,  253 => 64,  248 => 62,  244 => 61,  236 => 60,  232 => 59,  228 => 57,  222 => 56,  219 => 55,  216 => 54,  213 => 53,  208 => 52,  206 => 51,  198 => 47,  195 => 46,  193 => 45,  188 => 43,  180 => 40,  174 => 38,  169 => 37,  167 => 36,  157 => 31,  151 => 30,  145 => 29,  139 => 28,  133 => 24,  118 => 22,  114 => 21,  108 => 20,  102 => 17,  98 => 15,  94 => 14,  86 => 11,  83 => 10,  80 => 9,  76 => 8,  67 => 7,  62 => 5,  58 => 4,  51 => 3,  40 => 1,);
    }
